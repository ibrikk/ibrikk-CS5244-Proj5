...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Things We Never Got Over', 'Lucy Score', '', 15.60, 0, FALSE, FALSE, 1003);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('The Butcher and the Blackbird', 'Brynne Weaver', '', 23.50, 0, TRUE, FALSE, 1003);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('House of Earth and Blood', 'Sarah J. Maas', '', 23.99, 0, TRUE, FALSE, 1003);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('House of Sky and Breath', 'Sarah J. Maas', '', 24.99, 0, FALSE, FALSE, 1003);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Zodiac Academy 2', 'C. Peckham and S. Valenti', '', 23.50, 0, FALSE, FALSE, 1003);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Two Twisted Crowns', 'Rachel Gillig', '', 11.89, 0, TRUE, FALSE, 1003);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Iron and Flames', 'Rebecca Yarros', '', 19.99, 0, FALSE, FALSE, 1003);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('World of Walkers', 'Neal Asher', '', 29.92, 0, TRUE, FALSE, 1003);
...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Whenever I Hear That Song: The memoir', 'Martin Broughton', '', 26.70, 0, TRUE, FALSE, 1004);
...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('It Ends with Us', 'Colleen Hoover', '', 14.99, 0, FALSE, FALSE, 1005);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('The Christmas Fix', 'Lucy Score', '', 14.99, 0, TRUE, FALSE, 1005);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Counting Miracles', 'Nicholas Sparks', '', 30.96, 0, TRUE, FALSE, 1005);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Here One Moment', 'Liane Moriarty', '', 20.00, 0, TRUE, FALSE, 1005);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('The Forty Rules of Love: A Novel of Rumi', 'Elif Shafak', '', 14.99, 0, TRUE, FALSE, 1005);
...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Life on Svalbard: Finding Home on a Remote Island', 'Cecilia Blomdahl', '', 60.21, 0, TRUE, FALSE, 1006);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('The Ride of Her Life: The True Story of a Woman, Her Horse', 'Elizabeth Letts', '', 28.34, 0, FALSE, FALSE, 1006);

INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) 
VALUES ('The Complete Mediterranean Cookbook', 'The Editors at America\'s Test Kitchen', '', 24.99, 0, TRUE, FALSE, 1007);
...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('100 Cookies: The Baking Book for Every Kitchen', 'Sarah Kieffer', '', 19.99, 0, FALSE, FALSE, 1007);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Baking 101: From Cookies to Cakes and Everything In-Between', 'Gordon Ramsay', '', 11.30, 0, TRUE, FALSE, 1007);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('The Food Lab: Better Home Cooking Through Science', 'J. Kenji López-Alt', '', 35.00, 0, TRUE, FALSE, 1007);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Natasha\'s Kitchen: 100+ Easy Family-Favorite Recipes', 'Natasha Kravchuk', '', 11.43, 0, TRUE, FALSE, 1007);


INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('The Alchemist', 'Paulo Coelho', '', 14.99, 0, TRUE, FALSE, 1008);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Life of Pi', 'Yann Martel', '', 12.98, 0, TRUE, FALSE, 1008);
...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Building DIY Websites for Dummies', 'Jennifer DeRosa', '', 8.75, 0, FALSE, FALSE, 1009);
...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Beginner\'s Guide to DIY & Home Repair', 'Jo Behari, Alison Winfield-Chislett', '', 25.43, 0, FALSE, FALSE, 1009);
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('DIY String Art: 24 Designs to Create and Hang', 'Jesse Dresbach', '', 17.88, 0, TRUE, FALSE, 1009);